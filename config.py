...
if ENVIRONMENT == "production": # production/deployment
    ...
    PRICE_POOL_ID = 000
    SUBMIT_PROOF_CHANNEL_ID = 1357324254374264873  # Play2Earn1v1 Discord Server
    GIVEAWAY_CHANNEL_ID = 1351236909770211359  # Play2Earn1v1 Discord Server
    INVITE_CHANNEL_ID = 1352803802972946453
    LEADERBOARD_CHANNEL_ID = 1357395393616543766
    ...
    SUBMIT_PROOF_CHANNEL_ID = 1357325493959131197 # SYC Dev Discord Server
    GIVEAWAY_CHANNEL_ID = 1338535496581644420 # SYC Dev Discord Server
    INVITE_CHANNEL_ID = 1338874480402890752
    LEADERBOARD_CHANNEL_ID = 1357397903311638568
    LEADERBOARD_MESSAGE_ID = 1357447635950244111
